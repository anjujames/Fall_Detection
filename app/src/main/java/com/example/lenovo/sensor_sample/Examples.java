  ...
  long response_mode,resp_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // tv=(TextView)findViewById(R.id.sp_text);
        ...
        resp_time=response_mode/600000;
...
// function to stop the ringtone after 10 second and start a voice message regarding fall alert
    ...
    timer = new CountDownTimer(response_mode, 100) {
        ...
        public void onFinish() {
            ...
            String sms_msg = "The sender of this message may have been injured. Please find the location of the sender using the link:"+" " + "http://maps.google.com/maps/@" + latitude + "," + longitude + "/";
            try {
  ...
  public void speakout()
  {
    Log.e("Speech", "In speech module");
      t1.speak("A fall has been detected, please cancel the SMS alert if you are not injured", TextToSpeech.QUEUE_FLUSH, null);
